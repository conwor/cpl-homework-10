...
Прочитать с клавиатуры число `С`. Затем прочитатать `C` команд. Если Пакман на своём пути хоть
раз побывал в клетке с Едой, вывести число 1. Иначе вывести число 0.
